...
public class c {
    ...
    public static class Month implements Comparable<Month> {
        ...
        public String toString() {
            ...
            // WARNING: this function was changed to produce the same string format
            return i == ni ? "" : i2(y / 100) + i2(y % 100) + "." + i2(1 + m % 12) + "m";
        }
    ...
    public static class Timespan implements Comparable<Timespan> {
        ...
        public String toString() {
            ...
            // WARNING: this part changed to always add date
//      if (d != 0) {
            s += d + "D";
//      }
    ...
    public static class Composition {
        ...
        public Composition(Object[] args) {
            this.items = args;
        }
     ...
     */
    public static Object[] NULL = {null, Boolean.FALSE, new UUID(0, 0), null, (byte) 0,
            Short.MIN_VALUE, ni, nj, (float) nf, nf, ' ', "",
