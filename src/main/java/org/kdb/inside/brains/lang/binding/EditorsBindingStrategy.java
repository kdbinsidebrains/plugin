...
public enum EditorsBindingStrategy {
    ...
    CONNECT_TO_TAB("Bind a connection to the tab", "When active connection is changed, new connection is binding to current editor and will be auto-selected each time when the tab is activated. No binding is happen if active connection is not changed.");
