...
class RangeColumnInfo<T, V> extends ColumnInfo<T, V> {
    ...
    public RangeColumnInfo(String name, Function<T, V> getter, BiConsumer<T, V> setter) {
        this(name, getter, setter, null);
    }

    public RangeColumnInfo(String name, Function<T, V> getter, BiConsumer<T, V> setter, String maxStringValue) {
        super(name);
        this.getter = getter;
        this.setter = setter;
