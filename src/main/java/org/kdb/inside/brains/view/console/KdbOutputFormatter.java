...
public final class KdbOutputFormatter {
    ...
    public String convertObject(Object v) {
        if (v == null) {
            return formatNull();
        }
        ...
        if (v.getClass().isArray()) {
            return '(' + formatArray(v, this::convertObject, 10, ';') + ')';
        }
    ...
    public String formatDict(c.Dict d) {
        String k = convertObject(d.x);
        String v = convertObject(d.y);
