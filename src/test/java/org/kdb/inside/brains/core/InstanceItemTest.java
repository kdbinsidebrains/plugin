...
public class InstanceItemTest {
    ...
    public void treePath() {
        KdbInstance i = new KdbInstance("i1", "local", 34534, "asdas", InstanceOptions.INHERITED);
        ...
        i = p.createInstance("i1", "local", 12412, "asdasd", InstanceOptions.INHERITED);
        ...
        i = s.createInstance("i1", "local", 12412, "asdasd", InstanceOptions.INHERITED);
